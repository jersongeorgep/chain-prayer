        ...
        <form id="quickForm" action="<?= site_url('prayerpoints/makeSerialNumber/update/'. $serial_no->id) ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body row">
                <div class="form-group col-12">
                    <label for="serial_no">Serial No.</label>
                    <input type="text" name="serial_no" class="form-control form-control-sm" id="serial_no" placeholder="Serial No" value="<?= $serial_no->serial_no; ?>">
                </div>
            </div>
            <!-- /.card-body -->

...
<a href="<?= site_url('prayerchain/printdata/print_group_wise/'.$center_id.'/'.$group_no.'/'.$language->id);?>" target="_blank" class="btn btn-success btn-sm mt-2"><i class="fa fa-print"></i> Print</a>

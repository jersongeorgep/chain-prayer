        ...
        <form id="quickForm" action="<?= site_url('prayerpoints/update/'.$point->id) ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body row">
                    ...
                    <select class="form-control form-control-sm select2" name="serial_no" id="serial_no">
                        ...
                        <?php if ($serial_nos) : ?>
                            <?php foreach ($serial_nos as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= (($value->id == $point->serial_no) ? "selected" : "") ; ?> ><?= $value->serial_no; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <input type="text" name="title" class="form-control form-control-sm" id="title" placeholder="Title" value="<?= $point->title; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="point_eng">Point in English <sup class="text-danger">*</sup></label>
                    <textarea type="text" name="point_eng" class="form-control form-control-sm" id="point_eng" placeholder="Point in English" rows="3"><?= $point->point_eng; ?></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="point_mal">Point in Malayalam<sup class="text-danger">*</sup></label>
                    <textarea type="text" name="point_mal" class="form-control form-control-sm" id="point_mal" placeholder="Point in Malayalam" rows="3"><?= $point->point_mal; ?></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="point_tam">Point in Tamil <sup class="text-danger">*</sup></label>
                    <textarea type="text" name="point_tam" class="form-control form-control-sm" id="point_tam" placeholder="Point in Tamil" rows="3"><?= $point->point_tam; ?></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="c">Point in Telugu</label>
                    <textarea type="text" name="point_tel" class="form-control form-control-sm" id="point_tel" placeholder="Point in Telugu" rows="3"><?= $point->point_tel; ?></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="point_hin">Point in Hindi</label>
                    <textarea type="text" name="point_hin" class="form-control form-control-sm" id="point_hin" placeholder="Point in Hindi" rows="3"><?= $point->point_hin; ?></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="point_kan">Point in Kannada</label>
                    <textarea type="text" name="point_kan" class="form-control form-control-sm" id="point_kan" placeholder="Point in Kannada" rows="3"><?= $point->point_kan; ?></textarea>
                </div>
            </div>
            <!-- /.card-body -->

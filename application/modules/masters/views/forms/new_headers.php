        ...
        <form id="quickForm" action="<?= site_url('masters/Headers_data/save') ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body row">
                ...
                <div class="form-group col-sm-12 col-md-3">
                    ...
                    <input type="text" name="praise" class="form-control form-control-sm" id="praise" placeholder="Praise">
                </div>
                ...
                <div class="form-group col-sm-12 col-md-12">
                    ...
                    <textarea name="details" class="form-control form-control-sm" placeholder="Details"></textarea>
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="verses">Verses</label>
                    <textarea name="verses" class="form-control form-control-sm" placeholder="Verses"></textarea>
                </div>
            </div>
            <!-- /.card-body -->

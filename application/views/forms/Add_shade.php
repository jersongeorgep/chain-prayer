<?= isset($errors); ?>
<form method="post" action="<?= site_url('masters/shades/save/') ?>" enctype="multipart/form-data">
    <div class="form-group col-md-6">
        <label class="control-label mb-10" for="shade">Shade Name <sup class="text-danger">*</sup></label>
        <input type="text" class="form-control" id="shade" placeholder="Shade" name="shade" required>
    </div>

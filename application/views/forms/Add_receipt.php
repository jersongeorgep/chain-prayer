...
<div class="row">
    <form action="<?= site_url('office/receipts/save'); ?>" method="post" enctype="multipart/form-data">
        <div class="col-sm-8">
            <div class="form-group col-md-6">
                <label class="control-label mt-10" for="ref_no">Ref. No. <sup class="text-danger">*</sup></label>
                <input type="text" class="form-control" placeholder="Ref. No." value="<?= auto_number('receipts', 'ref_no', 'REC', 1000); ?>" readonly>
                <input type="hidden" id="po_number" placeholder="Ref. No." name="ref_no" value="<?= auto_number('receipts', 'ref_no', 'REC', 1000); ?>" />
            </div>
            <div class="form-group col-md-6">
                <label class="control-label mt-10" for="receipt_date">Date <sup class="text-danger">*</sup></label>
                <input type="text" class="form-control datepicker" id="receipt_date" placeholder="Date" name="receipt_date" required value="<?= date('d-m-Y') ?>">
            </div>
            ...
            <input type="text" class="form-control text-right" id="opening_balance" placeholder="0.00" name="opening_balance">
            </div>
            <div class="form-group col-md-4">
            <label class="control-label mt-10" for="current_balance">Current Balance</label>
            <input type="text" class="form-control text-right" readonly id="current_balance" placeholder="0.00" name="current_balance">
            </div>
            <div class="form-group col-md-4">
            <label class="control-label mt-10" for="receipt_amount">Amount <sup class="text-danger">*</sup></label>
            <input type="text" class="form-control text-right" id="receipt_amount" placeholder="0.00" name="receipt_amount">
            </div>
            <div class="form-group col-md-6">
            ...
            <select name="transaction_mode" id="transaction_mode" class="form-control select2">
                    ...
                    ?>
                        <option value="<?= $val00; ?>"><?= $val00; ?></option>
                    <?php
                    }
                    ?>
                </select>
            ...
            <input type="text" class="form-control" id="collected_by" placeholder="Collected By" name="collected_by">
            </div>
            <div class="form-group col-md-12">

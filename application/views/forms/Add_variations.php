...
<?= isset($errors); ?>
<form method="post" action="<?= site_url('masters/variations/save') ?>" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" id="variation_item" placeholder="Variation Name" name="variation_item" required>
    </div>

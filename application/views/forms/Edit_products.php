...
<?= isset($errors); ?>
<form method="post" action="<?= site_url('masters/products/update/'.$product->product_id) ?>" enctype="multipart/form-data">
        ...
        <select name="cate_id" id="cate_id" placeholder="Category" class="form-control select2" required>
            ...
            <?php 
                if($category){
                    ...
                    ?>
                       <option value="<?= $value->id; ?>" <?=(($product->ca_id == $value->id)? "Selected" : ""); ?>><?= $value->category_name; ?></option>
                    <?php 
                    }
                }
            ?>
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" id="product_name" placeholder="Variation Name" name="product_name" required value="<?= $product->product_name; ?>">
    </div>
    <div class="form-group col-md-12">
        <label class="control-label mt-10" for="descriptions">Description</label>
        <input type="text" class="form-control" id="descriptions" placeholder="Description" name="descriptions" value="<?= $product->descriptions; ?>">
    </div>
    <div class="form-group col-md-12">
        <label class="control-label mt-10" for="manufacture">Manufacturer</label>
        <input type="text" class="form-control" id="manufacture" placeholder="Manufacturer" name="manufacture"  value="<?= $product->manufacture; ?>">
    </div>
    <div class="form-group col-md-12">
        <label class="control-label mt-10" for="price">Price <sup class="text-danger">*</sup></label>
        <input type="text" class="form-control" id="price" placeholder="Price" name="price" required value="<?= $product->price; ?>">
    </div>

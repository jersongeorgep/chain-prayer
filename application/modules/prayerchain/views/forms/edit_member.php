        ...
        <form id="quickForm" action="<?= site_url('prayerchain/members/update/'. $member->id ); ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body row">
                    ...
                    <select class="form-control form-control-sm select2" name="center_id" id="center_id">
                        ...
                        <?php if ($center_fh) : ?>
                            <?php foreach ($center_fh as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= (($value->id == $member->center_id) ? "selected" : "") ;?>><?= $value->centerName; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="form-group col-sm-12 col-md-3">
                    ...
                    <option value="">Select</option>
                        <?php if ($local_fh) : ?>
                            <?php foreach ($local_fh as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= (($value->id == $member->local_id) ? "selected" : "") ;?>><?= $value->localName; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>                        
                    </select>
                </div>
                    ...
                    <select class="form-control form-control-sm select2" name="time_id" id="time_id">
                        ...
                        <?php if ($times) : ?>
                            <?php foreach ($times as $value) : ?>
                                <option value="<?= $value->id; ?>"  <?= (($value->id == $member->time_id) ? "selected" : "") ;?> ><?= $value->prayer_time; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                    ...
                    <select class="form-control form-control-sm select2" name="lang_id" id="lang_id">
                        ...
                        <?php if ($language) : ?>
                            <?php foreach ($language as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= (($value->id == $member->lang_id) ? "selected" : "") ;?>><?= $value->language; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="form-group col-sm-12 col-md-2">
                    ...
                    <input type="text" name="group_no" class="form-control form-control-sm" id="group_no" placeholder="Group No." value="<?= $member->group_no; ?>" readonly>
                </div>
                <div class="form-group col-sm-12 col-md-2">
                    ...
                    <select class="form-control form-control-sm select2" name="bro_sis" id="bro_sis">
                        ...
                        <?php if ($brosis) : ?>
                            <?php foreach ($brosis as $value) : ?>
                                <option value="<?= $value; ?>" <?= (($value == $member->bro_sis) ? "selected" : "") ;?> ><?= $value; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="form-group col-sm-12 col-md-4">
                    ...
                    <input type="text" name="eng_name" class="form-control form-control-sm" id="eng_name" placeholder="Name (ENG)" value="<?= $member->eng_name; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-4">
                    <label for="mal_name">Name in Malayalam <sup class="text-danger">*</sup></label>
                    <input type="text" name="mal_name" class="form-control form-control-sm" id="mal_name" placeholder="Name (MAL)" value="<?= $member->mal_name; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                    <label for="tam_name">Name in Tamil</label>
                    <input type="text" name="tam_name" class="form-control form-control-sm" id="tam_name" placeholder="Name (TAM)" value="<?= $member->tam_name; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                    <label for="tel_name">Name in Telugu</label>
                    <input type="text" name="tel_name" class="form-control form-control-sm" id="tel_name" placeholder="Name (TEL)" value="<?= $member->tel_name; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                    <label for="hin_name">Name in Hindi</label>
                    <input type="text" name="hin_name" class="form-control form-control-sm" id="hin_name" placeholder="Name (HIN)" value="<?= $member->hin_name; ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                    <label for="kan_name">Name in Kannada</label>
                    <input type="text" name="kan_name" class="form-control form-control-sm" id="kan_name" placeholder="Name (KAN)" value="<?= $member->kan_name; ?>">
                </div>

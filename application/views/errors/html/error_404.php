            ...
            <div class="row full-height-vh">
                <div class="col-md-12 col-lg-3 ml-auto d-flex align-items-center">
                    <div class="row text-center mb-3">
                        <div class="col-12">
                            <img src="<?php echo site_url('app-assets/img/portrait/avatars/avatar-10.png'); ?>" alt="User" width="300">
                        </div>
                        <div class="col-12">
                    ...
                    <div class="error-container">
                        ...
                        <div class="error-body">
                            ...
                            <div class="row py-2 justify-content-center">
                                <div class="col-8">
                                    <a class="btn btn-brown btn-raised btn-block font-medium-2" href="<?php echo site_url(); ?>"><i class="ft-home"></i> Back to Home</a>
                                </div>
                            </div>
                        </div>
                        <div class="error-footer bg-transparent">
                            <div class="row">
                                <p class="text-muted text-center col-12 py-1">© <?php echo date('Y');?> <a>Jeah Tech </a>Busibess Solution <i class="ft-heart font-small-3"></i></p>

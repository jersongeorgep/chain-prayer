        ...
        <form id="quickForm" action="<?= site_url('masters/local-fhs/save') ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body row">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <input type="text" name="localName" class="form-control form-control-sm" onchange="get_code(this.value)" id="localName" placeholder="Local Faith Home">
                </div>
                <div class="form-group col-sm-12 col-md-6">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <input type="text" name="contact" class="form-control form-control-sm" id="contact" placeholder="Phone">
                </div>
                <div class="form-group col-sm-12 col-md-12">
                    <label for="address">Address</label>
                    <textarea class="form-control from-control-sm" name="address" id="address" placeholder="Address"></textarea>
                </div>
            </div>
            <!-- /.card-body -->
